/**
 * ContentCarousel - Generic carousel component with custom navigation
 *
 * @component
 * @description A flexible carousel/slider component built on react-slick with custom arrow navigation.
 * Supports responsive breakpoints and configurable slide counts.
 *
 * @prop {React.ReactNode} children - Slide content elements
 * @prop {number} [items=1] - Number of slides to show on desktop
 * @prop {number} [itemsOnMobile=1] - Number of slides to show on mobile (<480px)
 * @prop {number} [itemsOnTablet=1] - Number of slides to show on tablet (<768px)
 * @prop {number} [speed=500] - Transition speed in milliseconds
 * @prop {boolean} [infinite=true] - Enable infinite loop
 * @prop {boolean} [dots=false] - Show dot indicators
 * @prop {string} [gap='10px'] - Gap between slides
 * @prop {boolean} [autoplay=false] - Enable autoplay
 *
 * @example
 * <ContentCarousel items={3} itemsOnMobile={1} gap="20px">
 *   <div>Slide 1</div>
 *   <div>Slide 2</div>
 *   <div>Slide 3</div>
 * </ContentCarousel>
 *
 * @dependencies react-slick, styled-components
 * @animation Slide transitions with configurable speed
 */
